...
from routerxpl.core.telnet.telnet_client import TelnetClient
...
class Exploit(TelnetClient):
    ...
    def _resolved_defaults(self):
        return wordlists.resolve_default_pairs(self.__module__, self.defaults)
    ...
    def attack(self):
        ...
        data = LockedIterator(self._resolved_defaults())
