...
```
exf > use creds/routers/netgear/telnet_default_creds
exf (Netgear Router Default Telnet Creds) > set target 192.168.1.1
[+] target => 192.168.1.1
exf (Netgear Router Default Telnet Creds) > run
[*] Running module...
