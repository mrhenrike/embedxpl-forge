...
```
rxf > use creds/routers/netgear/telnet_default_creds
rxf (Netgear Router Default Telnet Creds) > set target 192.168.1.1
[+] target => 192.168.1.1
rxf (Netgear Router Default Telnet Creds) > run
[*] Running module...
