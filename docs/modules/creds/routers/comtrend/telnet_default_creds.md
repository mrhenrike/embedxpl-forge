...
```
rxf > use creds/routers/comtrend/telnet_default_creds
rxf (Comtrend Router Default Telnet Creds) > set target 192.168.1.1
[+] target => 192.168.1.1
rxf (Comtrend Router Default Telnet Creds) > run
[*] Running module...
