...
```
exf > use creds/routers/comtrend/telnet_default_creds
exf (Comtrend Router Default Telnet Creds) > set target 192.168.1.1
[+] target => 192.168.1.1
exf (Comtrend Router Default Telnet Creds) > run
[*] Running module...
