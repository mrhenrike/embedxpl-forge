...
```
rxf > use creds/routers/tplink/telnet_default_creds
rxf (TP-Link Router Default Telnet Creds) > set target 192.168.1.1
[+] target => 192.168.1.1
rxf (TP-Link Router Default Telnet Creds) > run
[*] Running module...
