...
```
exf > use creds/routers/fortinet/telnet_default_creds
exf (Fortinet Router Default Telnet Creds) > set target 192.168.1.1
[+] target => 192.168.1.1
exf (Fortinet Router Default Telnet Creds) > run
[*] Running module...
