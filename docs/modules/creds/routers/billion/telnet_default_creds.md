...
```
rxf > use creds/routers/billion/telnet_default_creds
rxf (Billion Router Default Telnet Creds) > set target 192.168.1.1
[+] target => 192.168.1.1
rxf (Billion Router Default Telnet Creds) > run
[*] Running module...
