...
```
exf > use creds/routers/billion/telnet_default_creds
exf (Billion Router Default Telnet Creds) > set target 192.168.1.1
[+] target => 192.168.1.1
exf (Billion Router Default Telnet Creds) > run
[*] Running module...
