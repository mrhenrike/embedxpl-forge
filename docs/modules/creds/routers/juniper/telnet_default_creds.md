...
```
rxf > use creds/routers/juniper/telnet_default_creds
rxf (Juniper Router Default Telnet Creds) > set target 192.168.1.1
[+] target => 192.168.1.1
rxf (Juniper Router Default Telnet Creds) > run
[*] Running module...
