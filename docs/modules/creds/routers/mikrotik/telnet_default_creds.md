...
```
rxf > use creds/routers/mikrotik/telnet_default_creds
rxf (Mikrotik Router Default Telnet Creds) > set target 192.168.1.1
[+] target => 192.168.1.1
rxf (Mikrotik Router Default Telnet Creds) > run
[*] Running module...
