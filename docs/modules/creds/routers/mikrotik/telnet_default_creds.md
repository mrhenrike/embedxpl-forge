...
```
exf > use creds/routers/mikrotik/telnet_default_creds
exf (Mikrotik Router Default Telnet Creds) > set target 192.168.1.1
[+] target => 192.168.1.1
exf (Mikrotik Router Default Telnet Creds) > run
[*] Running module...
