...
```
exf > use creds/routers/huawei/telnet_default_creds
exf (Huawei Router Default Telnet Creds) > set target 192.168.1.1
[+] target => 192.168.1.1
exf (Huawei Router Default Telnet Creds) > run
[*] Running module...
