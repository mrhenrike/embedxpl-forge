...
```
rxf > use creds/routers/huawei/telnet_default_creds
rxf (Huawei Router Default Telnet Creds) > set target 192.168.1.1
[+] target => 192.168.1.1
rxf (Huawei Router Default Telnet Creds) > run
[*] Running module...
