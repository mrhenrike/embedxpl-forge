...
```
rxf > use creds/routers/ubiquiti/telnet_default_creds
rxf (Ubiquiti Router Default Telnet Creds) > set target 192.168.1.1
[+] target => 192.168.1.1
rxf (Ubiquiti Router Default Telnet Creds) > run
[*] Running module...
