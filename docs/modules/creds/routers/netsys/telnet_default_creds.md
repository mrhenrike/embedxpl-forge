...
```
exf > use creds/routers/netsys/telnet_default_creds
exf (Netsys Router Default Telnet Creds) > set target 192.168.1.1
[+] target => 192.168.1.1
exf (Netsys Router Default Telnet Creds) > run
[*] Running module...
