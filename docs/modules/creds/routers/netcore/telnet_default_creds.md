...
```
rxf > use creds/routers/netcore/telnet_default_creds
rxf (Netcore Router Default Telnet Creds) > set target 192.168.1.1
[+] target => 192.168.1.1
rxf (Netcore Router Default Telnet Creds) > run
[*] Running module...
