...
```
rxf > use creds/routers/thomson/telnet_default_creds
rxf (Thomson Router Default Telnet Creds) > set target 192.168.1.1
[+] target => 192.168.1.1
rxf (Thomson Router Default Telnet Creds) > run
[*] Running module...
