...
```
rxf > use creds/routers/ipfire/telnet_default_creds
rxf (IPFire Router Default Telnet Creds) > set target 192.168.1.1
[+] target => 192.168.1.1
rxf (IPFire Router Default Telnet Creds) > run
[*] Running module...
