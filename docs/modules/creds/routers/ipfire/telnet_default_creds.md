...
```
exf > use creds/routers/ipfire/telnet_default_creds
exf (IPFire Router Default Telnet Creds) > set target 192.168.1.1
[+] target => 192.168.1.1
exf (IPFire Router Default Telnet Creds) > run
[*] Running module...
