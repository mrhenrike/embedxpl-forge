...
```
rxf > use creds/routers/movistar/telnet_default_creds
rxf (Movistar Router Default Telnet Creds) > set target 192.168.1.1
[+] target => 192.168.1.1
rxf (Movistar Router Default Telnet Creds) > run
[*] Running module...
