...
```
exf > use creds/routers/technicolor/telnet_default_creds
exf (Technicolor Router Default Telnet Creds) > set target 192.168.1.1
[+] target => 192.168.1.1
exf (Technicolor Router Default Telnet Creds) > run
[*] Running module...
