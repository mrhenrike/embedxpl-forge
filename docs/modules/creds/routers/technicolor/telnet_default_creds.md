...
```
rxf > use creds/routers/technicolor/telnet_default_creds
rxf (Technicolor Router Default Telnet Creds) > set target 192.168.1.1
[+] target => 192.168.1.1
rxf (Technicolor Router Default Telnet Creds) > run
[*] Running module...
