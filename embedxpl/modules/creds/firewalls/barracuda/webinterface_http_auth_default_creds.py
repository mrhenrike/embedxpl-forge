...
class Exploit(HTTPBasicDigestDefault):
    """Barracuda Networks Firewall — Default Web Interface Credentials (HTTP Basic/Digest Auth).
    ...
    __info__ = {
        "name": "Barracuda Networks Firewall Default Web Interface Creds - HTTP Auth",
        "description": (
            "Module performs dictionary attack against Barracuda Networks Firewall Web Interface "
