...
class Exploit(SNMPBruteforce):
    """Cisco Catalyst Switch — Default SNMP Community Strings.
    ...
    __info__ = {
        "name": "Cisco Catalyst Switch Default SNMP Community Strings",
        "description": (
            "Module performs dictionary attack against Cisco Catalyst Switch SNMP service "
