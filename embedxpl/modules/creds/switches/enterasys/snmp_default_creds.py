...
class Exploit(SNMPBruteforce):
    """Enterasys Switch — Default SNMP Community Strings.
    ...
    __info__ = {
        "name": "Enterasys Switch Default SNMP Community Strings",
        "description": (
            "Module performs dictionary attack against Enterasys Switch SNMP service "
