...
class Exploit(SNMPBruteforce):
    """Foundry Networks/FastIron — Default SNMP Community Strings.
    ...
    __info__ = {
        "name": "Foundry Networks/FastIron Default SNMP Community Strings",
        "description": (
            "Module performs dictionary attack against Foundry Networks/FastIron SNMP service "
