...
class Exploit(SNMPBruteforce):
    """HP ProCurve Switch — Default SNMP Community Strings.
    ...
    __info__ = {
        "name": "HP ProCurve Switch Default SNMP Community Strings",
        "description": (
            "Module performs dictionary attack against HP ProCurve Switch SNMP service "
