...
class Exploit(HTTPBasicDigestDefault):
    """Allied Telesyn/Telesis Switch — Default Web Interface Credentials (HTTP Basic/Digest Auth).
    ...
    __info__ = {
        "name": "Allied Telesyn/Telesis Switch Default Web Interface Creds - HTTP Auth",
        "description": (
            "Module performs dictionary attack against Allied Telesyn/Telesis Switch Web Interface "
