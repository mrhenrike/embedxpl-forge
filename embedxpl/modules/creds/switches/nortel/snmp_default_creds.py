...
class Exploit(SNMPBruteforce):
    """Nortel Accelar/Passport Switch — Default SNMP Community Strings.
    ...
    __info__ = {
        "name": "Nortel Accelar/Passport Switch Default SNMP Community Strings",
        "description": (
            "Module performs dictionary attack against Nortel Accelar/Passport Switch SNMP service "
