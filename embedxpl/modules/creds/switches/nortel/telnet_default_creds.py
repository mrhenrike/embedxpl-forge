...
class Exploit(TelnetDefault):
    """Nortel Accelar/Passport Switch — Default Telnet Credentials.
    ...
    __info__ = {
        "name": "Nortel Accelar/Passport Switch Default Telnet Creds",
        "description": (
            "Module performs dictionary attack with default credentials against "
            "Nortel Accelar/Passport Switch Telnet service. "
