...
class Exploit(HTTPBasicDigestDefault):
    """Accton/EdgeCore Switch — Default Web Interface Credentials (HTTP Basic/Digest Auth).
    ...
    __info__ = {
        "name": "Accton/EdgeCore Switch Default Web Interface Creds - HTTP Auth",
        "description": (
            "Module performs dictionary attack against Accton/EdgeCore Switch Web Interface "
