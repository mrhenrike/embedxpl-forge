...
class Exploit(HTTPBasicDigestDefault):
    """Arris Cable Modem/CPE — Default Web Interface Credentials (HTTP Basic/Digest Auth).
    ...
    __info__ = {
        "name": "Arris Cable Modem/CPE Default Web Interface Creds - HTTP Auth",
        "description": (
            "Module performs dictionary attack against Arris Cable Modem/CPE Web Interface "
