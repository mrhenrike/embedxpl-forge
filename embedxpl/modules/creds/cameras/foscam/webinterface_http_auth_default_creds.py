...
class Exploit(HTTPBasicDigestDefault):
    """Foscam IP Camera — Default Web Interface Credentials (HTTP Basic/Digest Auth).
    ...
    __info__ = {
        "name": "Foscam IP Camera Default Web Interface Creds - HTTP Auth",
        "description": (
            "Module performs dictionary attack against Foscam IP Camera Web Interface "
