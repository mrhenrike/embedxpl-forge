...
class Exploit(HTTPBasicDigestDefault):
    """March Networks Recorder — Default Web Interface Credentials (HTTP Basic/Digest Auth).
    ...
    __info__ = {
        "name": "March Networks Recorder Default Web Interface Creds - HTTP Auth",
        "description": (
            "Module performs dictionary attack against March Networks Recorder Web Interface "
