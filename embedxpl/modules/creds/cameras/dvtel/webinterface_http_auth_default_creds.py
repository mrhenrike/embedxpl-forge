...
class Exploit(HTTPBasicDigestDefault):
    """DVTel IP Camera/VMS — Default Web Interface Credentials (HTTP Basic/Digest Auth).
    ...
    __info__ = {
        "name": "DVTel IP Camera/VMS Default Web Interface Creds - HTTP Auth",
        "description": (
            "Module performs dictionary attack against DVTel IP Camera/VMS Web Interface "
