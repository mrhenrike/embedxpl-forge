...
class Exploit(HTTPBasicDigestDefault):
    """Toshiba e-STUDIO Printer — Default Web Interface Credentials (HTTP Basic/Digest Auth).
    ...
    __info__ = {
        "name": "Toshiba e-STUDIO Printer Default Web Interface Creds - HTTP Auth",
        "description": (
            "Module performs dictionary attack against Toshiba e-STUDIO Printer Web Interface "
