...
class Exploit(HTTPBasicDigestDefault):
    """Brother HL/MFC Printer — Default Web Interface Credentials (HTTP Basic/Digest Auth).
    ...
    __info__ = {
        "name": "Brother HL/MFC Printer Default Web Interface Creds - HTTP Auth",
        "description": (
            "Module performs dictionary attack against Brother HL/MFC Printer Web Interface "
