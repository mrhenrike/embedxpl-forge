...
class Exploit(HTTPBasicDigestDefault):
    """Samsung ML/CLX/SCX Printer — Default Web Interface Credentials (HTTP Basic/Digest Auth).
    ...
    __info__ = {
        "name": "Samsung ML/CLX/SCX Printer Default Web Interface Creds - HTTP Auth",
        "description": (
            "Module performs dictionary attack against Samsung ML/CLX/SCX Printer Web Interface "
