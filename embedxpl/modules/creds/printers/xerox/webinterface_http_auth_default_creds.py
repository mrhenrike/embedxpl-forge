...
class Exploit(HTTPBasicDigestDefault):
    """Xerox WorkCentre/ColorQube — Default Web Interface Credentials (HTTP Basic/Digest Auth).
    ...
    __info__ = {
        "name": "Xerox WorkCentre/ColorQube Default Web Interface Creds - HTTP Auth",
        "description": (
            "Module performs dictionary attack against Xerox WorkCentre/ColorQube Web Interface "
