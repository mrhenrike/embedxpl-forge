...
class Exploit(HTTPBasicDigestDefault):
    """Western Digital My Cloud NAS — Default Web Interface Credentials (HTTP Basic/Digest Auth).
    ...
    __info__ = {
        "name": "Western Digital My Cloud NAS Default Web Interface Creds - HTTP Auth",
        "description": (
            "Module performs dictionary attack against Western Digital My Cloud NAS Web Interface "
