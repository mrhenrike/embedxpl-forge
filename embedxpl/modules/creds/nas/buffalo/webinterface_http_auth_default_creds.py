...
class Exploit(HTTPBasicDigestDefault):
    """Buffalo LinkStation/TeraStation NAS — Default Web Interface Credentials (HTTP Basic/Digest Auth).
    ...
    __info__ = {
        "name": "Buffalo LinkStation/TeraStation NAS Default Web Interface Creds - HTTP Auth",
        "description": (
            "Module performs dictionary attack against Buffalo LinkStation/TeraStation NAS Web Interface "
