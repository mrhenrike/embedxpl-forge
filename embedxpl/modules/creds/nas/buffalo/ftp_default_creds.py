...
class Exploit(FTPDefault):
    """Buffalo LinkStation/TeraStation NAS — Default FTP Credentials.
    ...
    __info__ = {
        "name": "Buffalo LinkStation/TeraStation NAS Default FTP Creds",
        "description": (
            "Module performs dictionary attack with default credentials against "
            "Buffalo LinkStation/TeraStation NAS FTP service. "
