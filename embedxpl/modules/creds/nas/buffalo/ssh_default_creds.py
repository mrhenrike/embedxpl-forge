...
class Exploit(SSHDefault):
    """Buffalo LinkStation/TeraStation NAS — Default SSH Credentials.
    ...
    __info__ = {
        "name": "Buffalo LinkStation/TeraStation NAS Default SSH Creds",
        "description": (
            "Module performs dictionary attack with default credentials against "
            "Buffalo LinkStation/TeraStation NAS SSH service. "
