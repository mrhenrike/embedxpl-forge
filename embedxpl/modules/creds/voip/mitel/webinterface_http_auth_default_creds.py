...
class Exploit(HTTPBasicDigestDefault):
    """Mitel MiVoice PBX — Default Web Interface Credentials (HTTP Basic/Digest Auth).
    ...
    __info__ = {
        "name": "Mitel MiVoice PBX Default Web Interface Creds - HTTP Auth",
        "description": (
            "Module performs dictionary attack against Mitel MiVoice PBX Web Interface "
