...
class Exploit(HTTPBasicDigestDefault):
    __info__ = {
        "name": "Kingtype Router Default Web Interface Creds",
        "description": "Dictionary attack against Kingtype Router Web Interface (HTTP Basic/Digest Auth).",
        "authors": ("André Henrique (@mrhenrike) — EmbedXPL-Forge",),
        "devices": ("Kingtype Router",),
    }
