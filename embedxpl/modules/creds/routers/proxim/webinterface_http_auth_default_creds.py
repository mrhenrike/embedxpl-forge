...
class Exploit(HTTPBasicDigestDefault):
    """Proxim Wireless AP/Bridge — Default Web Interface Credentials (HTTP Basic/Digest Auth).
    ...
    __info__ = {
        "name": "Proxim Wireless AP/Bridge Default Web Interface Creds - HTTP Auth",
        "description": (
            "Module performs dictionary attack against Proxim Wireless AP/Bridge Web Interface "
