...
class Exploit(HTTPBasicDigestDefault):
    __info__ = {
        "name": "Legrand Router Default Web Interface Creds",
        "description": "Dictionary attack against Legrand Router Web Interface (HTTP Basic/Digest Auth).",
        "authors": ("André Henrique (@mrhenrike) — EmbedXPL-Forge",),
        "devices": ("Legrand Router",),
    }
