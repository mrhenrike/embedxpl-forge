...
class Exploit(HTTPBasicDigestDefault):
    __info__ = {
        "name": "Western Digital Router Default Web Interface Creds",
        "description": "Dictionary attack against Western Digital Router Web Interface (HTTP Basic/Digest Auth).",
        "authors": ("André Henrique (@mrhenrike) — EmbedXPL-Forge",),
        "devices": ("Western Digital Router",),
    }
