...
class Exploit(HTTPBasicDigestDefault):
    __info__ = {
        "name": "Amped Wireless Router Default Web Interface Creds",
        "description": "Dictionary attack against Amped Wireless Router Web Interface (HTTP Basic/Digest Auth).",
        "authors": ("André Henrique (@mrhenrike) — EmbedXPL-Forge",),
        "devices": ("Amped Wireless Router",),
    }
