...
class Exploit(HTTPBasicDigestDefault):
    __info__ = {
        "name": "Ice Net Router Default Web Interface Creds",
        "description": "Dictionary attack against Ice Net Router Web Interface (HTTP Basic/Digest Auth).",
        "authors": ("André Henrique (@mrhenrike) — EmbedXPL-Forge",),
        "devices": ("Ice Net Router",),
    }
