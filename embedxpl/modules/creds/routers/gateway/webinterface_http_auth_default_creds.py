...
class Exploit(HTTPBasicDigestDefault):
    __info__ = {
        "name": "Gateway Router Default Web Interface Creds",
        "description": "Dictionary attack against Gateway Router Web Interface (HTTP Basic/Digest Auth).",
        "authors": ("André Henrique (@mrhenrike) — EmbedXPL-Forge",),
        "devices": ("Gateway Router",),
    }
