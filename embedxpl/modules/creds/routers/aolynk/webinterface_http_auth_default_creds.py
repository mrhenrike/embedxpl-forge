...
class Exploit(HTTPBasicDigestDefault):
    __info__ = {
        "name": "Aolynk Router Default Web Interface Creds",
        "description": "Dictionary attack against Aolynk Router Web Interface (HTTP Basic/Digest Auth).",
        "authors": ("André Henrique (@mrhenrike) — EmbedXPL-Forge",),
        "devices": ("Aolynk Router",),
    }
