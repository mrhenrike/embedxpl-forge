...
class Exploit(HTTPBasicDigestDefault):
    __info__ = {
        "name": "Buffalo Router Default Web Interface Creds",
        "description": "Dictionary attack against Buffalo Router Web Interface (HTTP Basic/Digest Auth).",
        "authors": ("André Henrique (@mrhenrike) — EmbedXPL-Forge",),
        "devices": ("Buffalo Router",),
    }
