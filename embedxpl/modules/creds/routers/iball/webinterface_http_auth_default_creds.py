...
class Exploit(HTTPBasicDigestDefault):
    __info__ = {
        "name": "Iball Router Default Web Interface Creds",
        "description": "Dictionary attack against Iball Router Web Interface (HTTP Basic/Digest Auth).",
        "authors": ("André Henrique (@mrhenrike) — EmbedXPL-Forge",),
        "devices": ("Iball Router",),
    }
