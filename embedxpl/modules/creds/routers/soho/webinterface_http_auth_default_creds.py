...
class Exploit(HTTPBasicDigestDefault):
    __info__ = {
        "name": "Soho Router Default Web Interface Creds",
        "description": "Dictionary attack against Soho Router Web Interface (HTTP Basic/Digest Auth).",
    ...
    defaults = OptWordlist("admin:0000,admin:admin", "User:Pass or file with default credentials (file://)")
