...
class Exploit(HTTPBasicDigestDefault):
    __info__ = {
        "name": "Netgate Router Default Web Interface Creds",
        "description": "Dictionary attack against Netgate Router Web Interface (HTTP Basic/Digest Auth).",
        "authors": ("André Henrique (@mrhenrike) — EmbedXPL-Forge",),
        "devices": ("Netgate Router",),
    }
