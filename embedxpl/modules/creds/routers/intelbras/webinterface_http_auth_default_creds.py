...
class Exploit(HTTPBasicDigestDefault):
    __info__ = {
        "name": "Intelbras Router Default Web Interface Creds",
        "description": "Dictionary attack against Intelbras Router Web Interface (HTTP Basic/Digest Auth).",
        "authors": ("André Henrique (@mrhenrike) — EmbedXPL-Forge",),
        "devices": ("Intelbras Router",),
    }
