...
class Exploit(HTTPBasicDigestDefault):
    __info__ = {
        "name": "Eusso Router Default Web Interface Creds",
        "description": "Dictionary attack against Eusso Router Web Interface (HTTP Basic/Digest Auth).",
        "authors": ("André Henrique (@mrhenrike) — EmbedXPL-Forge",),
        "devices": ("Eusso Router",),
    }
