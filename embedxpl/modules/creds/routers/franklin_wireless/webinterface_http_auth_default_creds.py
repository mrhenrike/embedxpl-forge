...
class Exploit(HTTPBasicDigestDefault):
    __info__ = {
        "name": "Franklin Wireless Router Default Web Interface Creds",
        "description": "Dictionary attack against Franklin Wireless Router Web Interface (HTTP Basic/Digest Auth).",
        "authors": ("André Henrique (@mrhenrike) — EmbedXPL-Forge",),
        "devices": ("Franklin Wireless Router",),
    }
