...
class Exploit(TelnetDefault):
    __info__ = {
        "name": "Franklin Wireless Router Default Telnet Creds",
        "description": "Dictionary attack with default credentials against Franklin Wireless Router Telnet service.",
