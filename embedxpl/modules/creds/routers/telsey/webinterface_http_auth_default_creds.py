...
class Exploit(HTTPBasicDigestDefault):
    __info__ = {
        "name": "Telsey Router Default Web Interface Creds",
        "description": "Dictionary attack against Telsey Router Web Interface (HTTP Basic/Digest Auth).",
        "authors": ("André Henrique (@mrhenrike) — EmbedXPL-Forge",),
        "devices": ("Telsey Router",),
    }
