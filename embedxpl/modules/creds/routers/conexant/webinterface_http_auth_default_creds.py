...
class Exploit(HTTPBasicDigestDefault):
    __info__ = {
        "name": "Conexant Router Default Web Interface Creds",
        "description": "Dictionary attack against Conexant Router Web Interface (HTTP Basic/Digest Auth).",
        "authors": ("André Henrique (@mrhenrike) — EmbedXPL-Forge",),
        "devices": ("Conexant Router",),
    }
