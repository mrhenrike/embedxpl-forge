...
class Exploit(HTTPBasicDigestDefault):
    __info__ = {
        "name": "Pace Plc Router Default Web Interface Creds",
        "description": "Dictionary attack against Pace Plc Router Web Interface (HTTP Basic/Digest Auth).",
        "authors": ("André Henrique (@mrhenrike) — EmbedXPL-Forge",),
        "devices": ("Pace Plc Router",),
    }
