...
class Exploit(HTTPBasicDigestDefault):
    __info__ = {
        "name": "Beetel Router Default Web Interface Creds",
        "description": "Dictionary attack against Beetel Router Web Interface (HTTP Basic/Digest Auth).",
        "authors": ("André Henrique (@mrhenrike) — EmbedXPL-Forge",),
        "devices": ("Beetel Router",),
    }
