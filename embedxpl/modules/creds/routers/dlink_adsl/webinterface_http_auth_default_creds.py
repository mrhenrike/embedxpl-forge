...
class Exploit(HTTPBasicDigestDefault):
    """D-Link ADSL/DSL Modem — Default Web Interface Credentials (HTTP Basic/Digest Auth).
    ...
    __info__ = {
        "name": "D-Link ADSL/DSL Modem Default Web Interface Creds - HTTP Auth",
        "description": (
            "Module performs dictionary attack against D-Link ADSL/DSL Modem Web Interface "
