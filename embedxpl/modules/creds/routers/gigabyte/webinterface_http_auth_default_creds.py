...
class Exploit(HTTPBasicDigestDefault):
    __info__ = {
        "name": "Gigabyte Router Default Web Interface Creds",
        "description": "Dictionary attack against Gigabyte Router Web Interface (HTTP Basic/Digest Auth).",
        "authors": ("André Henrique (@mrhenrike) — EmbedXPL-Forge",),
        "devices": ("Gigabyte Router",),
    }
