...
class Exploit(HTTPBasicDigestDefault):
    __info__ = {
        "name": "Trendchip Router Default Web Interface Creds",
        "description": "Dictionary attack against Trendchip Router Web Interface (HTTP Basic/Digest Auth).",
        "authors": ("André Henrique (@mrhenrike) — EmbedXPL-Forge",),
        "devices": ("Trendchip Router",),
    }
