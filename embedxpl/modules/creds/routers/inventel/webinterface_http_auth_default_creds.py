...
class Exploit(HTTPBasicDigestDefault):
    __info__ = {
        "name": "Inventel Router Default Web Interface Creds",
        "description": "Dictionary attack against Inventel Router Web Interface (HTTP Basic/Digest Auth).",
        "authors": ("André Henrique (@mrhenrike) — EmbedXPL-Forge",),
        "devices": ("Inventel Router",),
    }
