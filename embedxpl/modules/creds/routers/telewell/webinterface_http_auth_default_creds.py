...
class Exploit(HTTPBasicDigestDefault):
    __info__ = {
        "name": "Telewell Router Default Web Interface Creds",
        "description": "Dictionary attack against Telewell Router Web Interface (HTTP Basic/Digest Auth).",
        "authors": ("André Henrique (@mrhenrike) — EmbedXPL-Forge",),
        "devices": ("Telewell Router",),
    }
