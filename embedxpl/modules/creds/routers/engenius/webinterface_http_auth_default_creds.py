...
class Exploit(HTTPBasicDigestDefault):
    __info__ = {
        "name": "Engenius Router Default Web Interface Creds",
        "description": "Dictionary attack against Engenius Router Web Interface (HTTP Basic/Digest Auth).",
        "authors": ("André Henrique (@mrhenrike) — EmbedXPL-Forge",),
        "devices": ("Engenius Router",),
    }
