...
class Exploit(HTTPBasicDigestDefault):
    __info__ = {
        "name": "Spectrum Router Default Web Interface Creds",
        "description": "Dictionary attack against Spectrum Router Web Interface (HTTP Basic/Digest Auth).",
        "authors": ("André Henrique (@mrhenrike) — EmbedXPL-Forge",),
        "devices": ("Spectrum Router",),
    }
