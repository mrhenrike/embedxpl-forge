...
class Exploit(HTTPBasicDigestDefault):
    __info__ = {
        "name": "Alcatel Lucent Router Default Web Interface Creds",
        "description": "Dictionary attack against Alcatel Lucent Router Web Interface (HTTP Basic/Digest Auth).",
