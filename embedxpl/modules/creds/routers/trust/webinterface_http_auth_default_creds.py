...
class Exploit(HTTPBasicDigestDefault):
    __info__ = {
        "name": "Trust Router Default Web Interface Creds",
        "description": "Dictionary attack against Trust Router Web Interface (HTTP Basic/Digest Auth).",
        "authors": ("André Henrique (@mrhenrike) — EmbedXPL-Forge",),
        "devices": ("Trust Router",),
    }
