...
class Exploit(HTTPBasicDigestDefault):
    __info__ = {
        "name": "Pluscom Router Default Web Interface Creds",
        "description": "Dictionary attack against Pluscom Router Web Interface (HTTP Basic/Digest Auth).",
        "authors": ("André Henrique (@mrhenrike) — EmbedXPL-Forge",),
        "devices": ("Pluscom Router",),
    }
