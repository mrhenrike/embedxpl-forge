...
class Exploit(HTTPBasicDigestDefault):
    __info__ = {
        "name": "X Micro Router Default Web Interface Creds",
        "description": "Dictionary attack against X Micro Router Web Interface (HTTP Basic/Digest Auth).",
        "authors": ("André Henrique (@mrhenrike) — EmbedXPL-Forge",),
        "devices": ("X Micro Router",),
    }
