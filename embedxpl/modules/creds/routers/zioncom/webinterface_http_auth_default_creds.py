...
class Exploit(HTTPBasicDigestDefault):
    __info__ = {
        "name": "Zioncom Router Default Web Interface Creds",
        "description": "Dictionary attack against Zioncom Router Web Interface (HTTP Basic/Digest Auth).",
        "authors": ("André Henrique (@mrhenrike) — EmbedXPL-Forge",),
        "devices": ("Zioncom Router",),
    }
