...
class Exploit(HTTPBasicDigestDefault):
    __info__ = {
        "name": "Luxul Router Default Web Interface Creds",
        "description": "Dictionary attack against Luxul Router Web Interface (HTTP Basic/Digest Auth).",
        "authors": ("André Henrique (@mrhenrike) — EmbedXPL-Forge",),
        "devices": ("Luxul Router",),
    }
