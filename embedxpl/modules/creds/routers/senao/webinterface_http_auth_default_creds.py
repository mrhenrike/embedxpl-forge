...
class Exploit(HTTPBasicDigestDefault):
    """Senao/EnGenius AP/Router — Default Web Interface Credentials (HTTP Basic/Digest Auth).
    ...
    __info__ = {
        "name": "Senao/EnGenius AP/Router Default Web Interface Creds - HTTP Auth",
        "description": (
            "Module performs dictionary attack against Senao/EnGenius AP/Router Web Interface "
