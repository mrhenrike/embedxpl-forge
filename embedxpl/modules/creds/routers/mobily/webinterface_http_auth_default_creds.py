...
class Exploit(HTTPBasicDigestDefault):
    __info__ = {
        "name": "Mobily Router Default Web Interface Creds",
        "description": "Dictionary attack against Mobily Router Web Interface (HTTP Basic/Digest Auth).",
        "authors": ("André Henrique (@mrhenrike) — EmbedXPL-Forge",),
        "devices": ("Mobily Router",),
    }
