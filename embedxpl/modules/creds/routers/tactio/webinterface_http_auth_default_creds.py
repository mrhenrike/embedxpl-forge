...
class Exploit(HTTPBasicDigestDefault):
    __info__ = {
        "name": "Tactio Router Default Web Interface Creds",
        "description": "Dictionary attack against Tactio Router Web Interface (HTTP Basic/Digest Auth).",
        "authors": ("André Henrique (@mrhenrike) — EmbedXPL-Forge",),
        "devices": ("Tactio Router",),
    }
