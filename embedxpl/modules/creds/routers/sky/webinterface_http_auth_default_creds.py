...
class Exploit(HTTPBasicDigestDefault):
    __info__ = {
        "name": "Sky Router Default Web Interface Creds",
        "description": "Dictionary attack against Sky Router Web Interface (HTTP Basic/Digest Auth).",
    ...
    defaults = OptWordlist("admin:lightweight,admin:sky,sky:lightweight,sky:sky", "User:Pass or file with default credentials (file://)")
