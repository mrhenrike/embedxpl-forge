...
class Exploit(HTTPBasicDigestDefault):
    __info__ = {
        "name": "Bell Router Default Web Interface Creds",
        "description": "Dictionary attack against Bell Router Web Interface (HTTP Basic/Digest Auth).",
    ...
    defaults = OptWordlist("admin:admin,unknown:admin", "User:Pass or file with default credentials (file://)")
