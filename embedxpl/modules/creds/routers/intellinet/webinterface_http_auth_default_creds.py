...
class Exploit(HTTPBasicDigestDefault):
    __info__ = {
        "name": "Intellinet Router Default Web Interface Creds",
        "description": "Dictionary attack against Intellinet Router Web Interface (HTTP Basic/Digest Auth).",
        "authors": ("André Henrique (@mrhenrike) — EmbedXPL-Forge",),
        "devices": ("Intellinet Router",),
    }
