...
class Exploit(HTTPBasicDigestDefault):
    __info__ = {
        "name": "Tot Router Default Web Interface Creds",
        "description": "Dictionary attack against Tot Router Web Interface (HTTP Basic/Digest Auth).",
    ...
    defaults = OptWordlist("admin:tot", "User:Pass or file with default credentials (file://)")
