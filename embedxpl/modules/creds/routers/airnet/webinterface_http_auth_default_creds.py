...
class Exploit(HTTPBasicDigestDefault):
    __info__ = {
        "name": "Airnet Router Default Web Interface Creds",
        "description": "Dictionary attack against Airnet Router Web Interface (HTTP Basic/Digest Auth).",
        "authors": ("André Henrique (@mrhenrike) — EmbedXPL-Forge",),
        "devices": ("Airnet Router",),
    }
