...
class Exploit(HTTPBasicDigestDefault):
    __info__ = {
        "name": "Quicktel Router Default Web Interface Creds",
        "description": "Dictionary attack against Quicktel Router Web Interface (HTTP Basic/Digest Auth).",
        "authors": ("André Henrique (@mrhenrike) — EmbedXPL-Forge",),
        "devices": ("Quicktel Router",),
    }
