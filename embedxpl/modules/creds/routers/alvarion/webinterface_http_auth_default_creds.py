...
class Exploit(HTTPBasicDigestDefault):
    __info__ = {
        "name": "Alvarion Router Default Web Interface Creds",
        "description": "Dictionary attack against Alvarion Router Web Interface (HTTP Basic/Digest Auth).",
        "authors": ("André Henrique (@mrhenrike) — EmbedXPL-Forge",),
        "devices": ("Alvarion Router",),
    }
