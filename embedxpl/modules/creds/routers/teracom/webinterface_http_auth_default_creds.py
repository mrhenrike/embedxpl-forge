...
class Exploit(HTTPBasicDigestDefault):
    __info__ = {
        "name": "Teracom Router Default Web Interface Creds",
        "description": "Dictionary attack against Teracom Router Web Interface (HTTP Basic/Digest Auth).",
        "authors": ("André Henrique (@mrhenrike) — EmbedXPL-Forge",),
        "devices": ("Teracom Router",),
    }
