...
class Exploit(HTTPBasicDigestDefault):
    __info__ = {
        "name": "Lectron Router Default Web Interface Creds",
        "description": "Dictionary attack against Lectron Router Web Interface (HTTP Basic/Digest Auth).",
        "authors": ("André Henrique (@mrhenrike) — EmbedXPL-Forge",),
        "devices": ("Lectron Router",),
    }
