...
class Exploit(HTTPBasicDigestDefault):
    __info__ = {
        "name": "Creative Router Default Web Interface Creds",
        "description": "Dictionary attack against Creative Router Web Interface (HTTP Basic/Digest Auth).",
        "authors": ("André Henrique (@mrhenrike) — EmbedXPL-Forge",),
        "devices": ("Creative Router",),
    }
