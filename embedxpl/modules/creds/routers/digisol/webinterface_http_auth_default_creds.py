...
class Exploit(HTTPBasicDigestDefault):
    __info__ = {
        "name": "Digisol Router Default Web Interface Creds",
        "description": "Dictionary attack against Digisol Router Web Interface (HTTP Basic/Digest Auth).",
        "authors": ("André Henrique (@mrhenrike) — EmbedXPL-Forge",),
        "devices": ("Digisol Router",),
    }
