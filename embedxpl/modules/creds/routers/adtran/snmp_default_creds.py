...
class Exploit(SNMPBruteforce):
    """ADTRAN Router/Switch — Default SNMP Community Strings.
    ...
    __info__ = {
        "name": "ADTRAN Router/Switch Default SNMP Community Strings",
        "description": (
            "Module performs dictionary attack against ADTRAN Router/Switch SNMP service "
