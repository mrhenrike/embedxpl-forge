...
class Exploit(HTTPBasicDigestDefault):
    __info__ = {
        "name": "1Net1 Router Default Web Interface Creds",
        "description": "Dictionary attack against 1Net1 Router Web Interface (HTTP Basic/Digest Auth).",
        "authors": ("André Henrique (@mrhenrike) — EmbedXPL-Forge",),
        "devices": ("1Net1 Router",),
    }
