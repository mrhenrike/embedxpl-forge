...
class Exploit(HTTPBasicDigestDefault):
    __info__ = {
        "name": "Mymax Router Default Web Interface Creds",
        "description": "Dictionary attack against Mymax Router Web Interface (HTTP Basic/Digest Auth).",
        "authors": ("André Henrique (@mrhenrike) — EmbedXPL-Forge",),
        "devices": ("Mymax Router",),
    }
