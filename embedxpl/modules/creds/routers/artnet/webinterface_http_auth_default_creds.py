...
class Exploit(HTTPBasicDigestDefault):
    __info__ = {
        "name": "Artnet Router Default Web Interface Creds",
        "description": "Dictionary attack against Artnet Router Web Interface (HTTP Basic/Digest Auth).",
        "authors": ("André Henrique (@mrhenrike) — EmbedXPL-Forge",),
        "devices": ("Artnet Router",),
    }
