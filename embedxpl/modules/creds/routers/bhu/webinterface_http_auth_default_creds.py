...
class Exploit(HTTPBasicDigestDefault):
    """BHU Router/CPE — Default Web Interface Credentials (HTTP Basic/Digest Auth).
    ...
    __info__ = {
        "name": "BHU Router/CPE Default Web Interface Creds - HTTP Auth",
        "description": (
            "Module performs dictionary attack against BHU Router/CPE Web Interface "
