...
class Exploit(HTTPBasicDigestDefault):
    __info__ = {
        "name": "Kozumi Router Default Web Interface Creds",
        "description": "Dictionary attack against Kozumi Router Web Interface (HTTP Basic/Digest Auth).",
        "authors": ("André Henrique (@mrhenrike) — EmbedXPL-Forge",),
        "devices": ("Kozumi Router",),
    }
