...
class Exploit(HTTPBasicDigestDefault):
    __info__ = {
        "name": "Paradigm Router Default Web Interface Creds",
        "description": "Dictionary attack against Paradigm Router Web Interface (HTTP Basic/Digest Auth).",
        "authors": ("André Henrique (@mrhenrike) — EmbedXPL-Forge",),
        "devices": ("Paradigm Router",),
    }
