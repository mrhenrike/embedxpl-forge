...
class Exploit(HTTPBasicDigestDefault):
    __info__ = {
        "name": "Hama Router Default Web Interface Creds",
        "description": "Dictionary attack against Hama Router Web Interface (HTTP Basic/Digest Auth).",
    ...
    defaults = OptWordlist("admin:admin,admin:epicrouter", "User:Pass or file with default credentials (file://)")
