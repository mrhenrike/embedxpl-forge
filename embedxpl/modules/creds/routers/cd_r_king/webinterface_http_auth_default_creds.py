...
class Exploit(HTTPBasicDigestDefault):
    __info__ = {
        "name": "Cd R King Router Default Web Interface Creds",
        "description": "Dictionary attack against Cd R King Router Web Interface (HTTP Basic/Digest Auth).",
        "authors": ("André Henrique (@mrhenrike) — EmbedXPL-Forge",),
        "devices": ("Cd R King Router",),
    }
