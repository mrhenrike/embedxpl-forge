...
class Exploit(HTTPBasicDigestDefault):
    __info__ = {
        "name": "Acorp Router Default Web Interface Creds",
        "description": "Dictionary attack against Acorp Router Web Interface (HTTP Basic/Digest Auth).",
        "authors": ("André Henrique (@mrhenrike) — EmbedXPL-Forge",),
        "devices": ("Acorp Router",),
    }
