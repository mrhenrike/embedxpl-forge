...
class Exploit(HTTPBasicDigestDefault):
    __info__ = {
        "name": "Humax Router Default Web Interface Creds",
        "description": "Dictionary attack against Humax Router Web Interface (HTTP Basic/Digest Auth).",
        "authors": ("André Henrique (@mrhenrike) — EmbedXPL-Forge",),
        "devices": ("Humax Router",),
    }
