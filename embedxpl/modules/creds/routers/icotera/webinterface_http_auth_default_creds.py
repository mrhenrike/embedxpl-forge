...
class Exploit(HTTPBasicDigestDefault):
    __info__ = {
        "name": "Icotera Router Default Web Interface Creds",
        "description": "Dictionary attack against Icotera Router Web Interface (HTTP Basic/Digest Auth).",
        "authors": ("André Henrique (@mrhenrike) — EmbedXPL-Forge",),
        "devices": ("Icotera Router",),
    }
