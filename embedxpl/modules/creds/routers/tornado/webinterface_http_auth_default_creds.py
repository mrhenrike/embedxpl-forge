...
class Exploit(HTTPBasicDigestDefault):
    __info__ = {
        "name": "Tornado Router Default Web Interface Creds",
        "description": "Dictionary attack against Tornado Router Web Interface (HTTP Basic/Digest Auth).",
        "authors": ("André Henrique (@mrhenrike) — EmbedXPL-Forge",),
        "devices": ("Tornado Router",),
    }
