...
class Exploit(HTTPBasicDigestDefault):
    __info__ = {
        "name": "Dovado Router Default Web Interface Creds",
        "description": "Dictionary attack against Dovado Router Web Interface (HTTP Basic/Digest Auth).",
        "authors": ("André Henrique (@mrhenrike) — EmbedXPL-Forge",),
        "devices": ("Dovado Router",),
    }
