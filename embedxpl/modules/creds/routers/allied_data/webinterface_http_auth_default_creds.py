...
class Exploit(HTTPBasicDigestDefault):
    __info__ = {
        "name": "Allied Data Router Default Web Interface Creds",
        "description": "Dictionary attack against Allied Data Router Web Interface (HTTP Basic/Digest Auth).",
        "authors": ("André Henrique (@mrhenrike) — EmbedXPL-Forge",),
        "devices": ("Allied Data Router",),
    }
