...
class Exploit(HTTPBasicDigestDefault):
    __info__ = {
        "name": "Samsung Router Default Web Interface Creds",
        "description": "Dictionary attack against Samsung Router Web Interface (HTTP Basic/Digest Auth).",
        "authors": ("André Henrique (@mrhenrike) — EmbedXPL-Forge",),
        "devices": ("Samsung Router",),
    }
