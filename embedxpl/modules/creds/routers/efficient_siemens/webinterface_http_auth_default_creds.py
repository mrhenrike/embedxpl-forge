...
class Exploit(HTTPBasicDigestDefault):
    __info__ = {
        "name": "Efficient Siemens Router Default Web Interface Creds",
        "description": "Dictionary attack against Efficient Siemens Router Web Interface (HTTP Basic/Digest Auth).",
