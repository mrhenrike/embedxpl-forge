...
class Exploit(HTTPBasicDigestDefault):
    """TRENDnet Router/Switch — Default Web Interface Credentials (HTTP Basic/Digest Auth).
    ...
    __info__ = {
        "name": "TRENDnet Router/Switch Default Web Interface Creds - HTTP Auth",
        "description": (
            "Module performs dictionary attack against TRENDnet Router/Switch Web Interface "
