...
class Exploit(HTTPBasicDigestDefault):
    __info__ = {
        "name": "Dynex Router Default Web Interface Creds",
        "description": "Dictionary attack against Dynex Router Web Interface (HTTP Basic/Digest Auth).",
        "authors": ("André Henrique (@mrhenrike) — EmbedXPL-Forge",),
        "devices": ("Dynex Router",),
    }
