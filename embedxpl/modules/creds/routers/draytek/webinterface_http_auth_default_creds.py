...
class Exploit(HTTPBasicDigestDefault):
    """DrayTek Vigor Router — Default Web Interface Credentials (HTTP Basic/Digest Auth).
    ...
    __info__ = {
        "name": "DrayTek Vigor Router Default Web Interface Creds - HTTP Auth",
        "description": (
            "Module performs dictionary attack against DrayTek Vigor Router Web Interface "
