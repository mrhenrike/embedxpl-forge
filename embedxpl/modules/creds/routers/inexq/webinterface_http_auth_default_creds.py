...
class Exploit(HTTPBasicDigestDefault):
    __info__ = {
        "name": "Inexq Router Default Web Interface Creds",
        "description": "Dictionary attack against Inexq Router Web Interface (HTTP Basic/Digest Auth).",
        "authors": ("André Henrique (@mrhenrike) — EmbedXPL-Forge",),
        "devices": ("Inexq Router",),
    }
