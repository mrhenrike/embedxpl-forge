...
class Exploit(HTTPBasicDigestDefault):
    __info__ = {
        "name": "Pronets Router Default Web Interface Creds",
        "description": "Dictionary attack against Pronets Router Web Interface (HTTP Basic/Digest Auth).",
        "authors": ("André Henrique (@mrhenrike) — EmbedXPL-Forge",),
        "devices": ("Pronets Router",),
    }
