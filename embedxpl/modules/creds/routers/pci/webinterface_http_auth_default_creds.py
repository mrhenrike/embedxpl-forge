...
class Exploit(HTTPBasicDigestDefault):
    __info__ = {
        "name": "Pci Router Default Web Interface Creds",
        "description": "Dictionary attack against Pci Router Web Interface (HTTP Basic/Digest Auth).",
    ...
    defaults = OptWordlist("admin:0000", "User:Pass or file with default credentials (file://)")
