...
class Exploit(HTTPBasicDigestDefault):
    __info__ = {
        "name": "E Tech Router Default Web Interface Creds",
        "description": "Dictionary attack against E Tech Router Web Interface (HTTP Basic/Digest Auth).",
        "authors": ("André Henrique (@mrhenrike) — EmbedXPL-Forge",),
        "devices": ("E Tech Router",),
    }
