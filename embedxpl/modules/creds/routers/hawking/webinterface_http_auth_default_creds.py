...
class Exploit(HTTPBasicDigestDefault):
    __info__ = {
        "name": "Hawking Router Default Web Interface Creds",
        "description": "Dictionary attack against Hawking Router Web Interface (HTTP Basic/Digest Auth).",
        "authors": ("André Henrique (@mrhenrike) — EmbedXPL-Forge",),
        "devices": ("Hawking Router",),
    }
