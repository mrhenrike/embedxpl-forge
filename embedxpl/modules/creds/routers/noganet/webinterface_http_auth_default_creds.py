...
class Exploit(HTTPBasicDigestDefault):
    __info__ = {
        "name": "Noganet Router Default Web Interface Creds",
        "description": "Dictionary attack against Noganet Router Web Interface (HTTP Basic/Digest Auth).",
        "authors": ("André Henrique (@mrhenrike) — EmbedXPL-Forge",),
        "devices": ("Noganet Router",),
    }
