...
class Exploit(HTTPBasicDigestDefault):
    __info__ = {
        "name": "Cisco Linksys Router Default Web Interface Creds",
        "description": "Dictionary attack against Cisco Linksys Router Web Interface (HTTP Basic/Digest Auth).",
        "authors": ("André Henrique (@mrhenrike) — EmbedXPL-Forge",),
        "devices": ("Cisco Linksys Router",),
    }
