...
class Exploit(HTTPBasicDigestDefault):
    __info__ = {
        "name": "Intracom Router Default Web Interface Creds",
        "description": "Dictionary attack against Intracom Router Web Interface (HTTP Basic/Digest Auth).",
        "authors": ("André Henrique (@mrhenrike) — EmbedXPL-Forge",),
        "devices": ("Intracom Router",),
    }
