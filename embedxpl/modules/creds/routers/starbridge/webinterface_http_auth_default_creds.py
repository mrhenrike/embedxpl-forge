...
class Exploit(HTTPBasicDigestDefault):
    __info__ = {
        "name": "Starbridge Router Default Web Interface Creds",
        "description": "Dictionary attack against Starbridge Router Web Interface (HTTP Basic/Digest Auth).",
        "authors": ("André Henrique (@mrhenrike) — EmbedXPL-Forge",),
        "devices": ("Starbridge Router",),
    }
