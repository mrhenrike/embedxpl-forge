...
class Exploit(HTTPBasicDigestDefault):
    __info__ = {
        "name": "Blitzz Router Default Web Interface Creds",
        "description": "Dictionary attack against Blitzz Router Web Interface (HTTP Basic/Digest Auth).",
        "authors": ("André Henrique (@mrhenrike) — EmbedXPL-Forge",),
        "devices": ("Blitzz Router",),
    }
