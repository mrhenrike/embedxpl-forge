...
class Exploit(HTTPBasicDigestDefault):
    __info__ = {
        "name": "Eltex Router Default Web Interface Creds",
        "description": "Dictionary attack against Eltex Router Web Interface (HTTP Basic/Digest Auth).",
        "authors": ("André Henrique (@mrhenrike) — EmbedXPL-Forge",),
        "devices": ("Eltex Router",),
    }
