import pytest
from routerxpl.core.exploit.utils import iter_modules


@pytest.mark.parametrize("exploit", iter_modules("./routerxpl/modules/exploit"))
...
@pytest.mark.parametrize("creds", iter_modules("./routerxpl/modules/creds"))
...
@pytest.mark.parametrize("scanner", iter_modules("./routerxpl/modules/scanners"))
...
@pytest.mark.parametrize("payload", iter_modules("./routerxpl/modules/payloads"))
...
@pytest.mark.parametrize("encoder", iter_modules("./routerxpl/modules/encoders"))
